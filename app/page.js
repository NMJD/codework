    ...
    <main>
      ...
      <section className="bg-base-200">
        <div className="max-w-3xl mx-auto flex justify-between items-center px-8 py-2">
          <div className="font-bold">CodeWork</div>
      ...
      <section className="text-center py-32 px-8 max-w-3xl mx-auto">
        ...
        <div className="opacity-90 mb-10">
          Create a feedback board in minutes, priorities features, and
        ...
        <div className="py-32 px-8 max-w-3xl mx-auto">
          ...
          <div className="p-8 bg-base-100 max-w-96 rounded-3xl mx-auto space-y-6">
            <div className="flex gap-2 items-baseline">
              <div className="text-4xl text-black">$19</div>
              <div className="text-sm uppercase font-medium opacity-60">/month</div>
            </div>

            <ul className="space-y-2">
              {
                ["Collect customer feedback", "Unlimited boards", "Admin dashboard", "24/7 support"].map((item) => (
                  <li className="flex items-center gap-2" key={item}>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className="text-green-600 size-4">
                      <path fillRule="evenodd" d="M12.416 3.376a.75.75 0 0 1 .208 1.04l-5 7.5a.75.75 0 0 1-1.154.114l-3-3a.75.75 0 0 1 1.06-1.06l2.353 2.353 4.493-6.74a.75.75 0 0 1 1.04-.207Z" className="flex items-center gap-2" clipRule="evenodd" />
                    </svg>
                    {item}
                  </li>)
                )
          ...
          <ul className="max-w-lg mx-auto">
            {
              [
                {
                  question: "What can I get exactly?",
